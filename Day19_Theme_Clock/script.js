...
function setTime() {
  ...
  secondNeedle.style.transition = `${seconds === 0 ? "none" : "all 0.5s ease-in"}`;
  minuteNeedle.style.transition = `${minutes === 0 ? "none" : "all 0.5s ease-in"}`;
  hourNeedle.style.transition = `${hours === 0 ? "none" : "all 0.5s ease-in"}`;
}
